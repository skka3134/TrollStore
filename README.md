...
| 状态 | 系统版本 | 说明 |
| :--- | :--- | :--- |
| 🟢 | iOS `15.0` - `16.6.1`, iOS `17.0` | 完美支持 |
| 🔴 | iOS `14.0 Beta 1` 及更早版本 | 不支持 |
| 🔴 | iOS `16.7` - `16.7.5` | 不支持（缺少必要漏洞） |
| 🔴 | iOS `17.0.1` 及更高版本 | 不支持 |

> **💡 小贴士**：iOS `17.0 beta 1-5` 理论上支持，但目前成功率不高，可以自行尝试。
...
**下载渠道**:
- 🆓 免费版: [GitHub 官方下载](https://github.com/Lessica/TrollRecorder)
